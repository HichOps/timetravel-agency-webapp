...
| Hero Section & Ambiance | Chatbot "Chronos" |
|:---:|:---:|
| ![Hero Section](https://i.imgur.com/fKLmrnA.png) | ![Interface Chatbot](https://i.imgur.com/os6B5eh.png) |

| Quiz de Personnalisation | Recommandation IA |
|:---:|:---:|
| ![Quiz Question](https://i.imgur.com/do2kZFW.png) | ![Résultat Quiz](https://i.imgur.com/441V8G3.png) |

<p align="center">
  <img src="https://i.imgur.com/12XsSk1.png" alt="Vue Mobile Responsive" width="400">
  <br>
  <em>Design Mobile-First Responsive</em>
</p>
...
* **Animations** : CSS Transitions & Framer Motion (simulé).

## ✨ Fonctionnalités Clés

1.  **Hero Section Immersive** : Design "Dark Mode" premium avec mise en avant des visuels Nano Banana.
2.  **Galerie Temporelle** : Cartes interactives présentant les époques (Paris 1889, Crétacé, Florence 1504).
3.  **🤖 Agent Chronos** : Chatbot intégré (simulé) capable de renseigner sur la sécurité, les prix et l'expérience voyageur avec une personnalité définie.
...
Ce projet a été réalisé en mode "Vibe Coding" pur.

### Ce qui a bien fonctionné :
* **Rapidité d'exécution** : Passer de l'idée au MVP déployé en un temps record grâce à la génération instantanée de Lovable.
* **Prompt Engineering** : L'utilisation de descriptions visuelles précises (inspirées des images générées) a permis d'obtenir un design cohérent du premier coup.
